...
# install miniconda
RUN wget --progress=dot:giga http://repo.continuum.io/miniconda/Miniconda-3.8.3-Linux-x86_64.sh && \
...
# install afni
RUN wget --progress=dot:giga http://afni.nimh.nih.gov/pub/dist/tgz/linux_openmp_64.tgz && \
